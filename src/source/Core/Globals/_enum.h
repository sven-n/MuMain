...
enum
{
    ...
    MODEL_GEM_OF_SECRET = MODEL_WING + 26,
    ...
    MODEL_SMALL_CAPE_OF_LORD = MODEL_WING + 130,
    MODEL_SMALL_WING_OF_CURSE = MODEL_WING + 131,
    MODEL_SMALL_WINGS_OF_ELF = MODEL_WING + 132,
    MODEL_SMALL_WINGS_OF_HEAVEN = MODEL_WING + 133,
    MODEL_SMALL_WINGS_OF_SATAN = MODEL_WING + 134,
    MODEL_LITTLE_WARRIORS_CLOAK = MODEL_WING + 135,
    ...
    MODEL_CONTRACT_SUMMON = MODEL_HELPER + 7,
    ...
    MODEL_SEAL_OF_ASCENSION = MODEL_HELPER + 43,
    MODEL_SEAL_OF_WEALTH = MODEL_HELPER + 44,
    MODEL_SEAL_OF_SUSTENANCE = MODEL_HELPER + 45,
    MODEL_DEVIL_SQUARE_TICKET = MODEL_HELPER + 46,
    MODEL_BLOOD_CASTLE_TICKET = MODEL_HELPER + 47,
    MODEL_KALIMA_TICKET = MODEL_HELPER + 48,
    ...
    MODEL_RESET_FRUIT_STRENGTH = MODEL_HELPER + 54,
    MODEL_RESET_FRUIT_QUICKNESS = MODEL_HELPER + 55,
    MODEL_RESET_FRUIT_HEALTH = MODEL_HELPER + 56,
    MODEL_RESET_FRUIT_ENERGY = MODEL_HELPER + 57,
    MODEL_RESET_FRUIT_CONTROL = MODEL_HELPER + 58,
    MODEL_SEAL_OF_MOBILITY = MODEL_HELPER + 59,
    MODEL_INDULGENCE = MODEL_HELPER + 60,
    MODEL_ILLUSION_TEMPLE_TICKET = MODEL_HELPER + 61,
    MODEL_SEAL_OF_HEALING = MODEL_HELPER + 62,
    MODEL_SEAL_OF_DIVINITY = MODEL_HELPER + 63,
    MODEL_DEMON = MODEL_HELPER + 64,
    MODEL_SPIRIT_OF_GUARDIAN = MODEL_HELPER + 65,
    MODEL_INVITATION_TO_SANTA_VILLAGE = MODEL_HELPER + 66,
    MODEL_PET_RUDOLF = MODEL_HELPER + 67,
    MODEL_SNOWMAN_TRANSFORMATION_RING = MODEL_HELPER + 68,
    MODEL_TALISMAN_OF_RESURRECTION = MODEL_HELPER + 69,
    MODEL_TALISMAN_OF_MOBILITY = MODEL_HELPER + 70,
    MODEL_GAMBLE_SWORD_MACE_SPEAR = MODEL_HELPER + 71,
    MODEL_GAMBLE_STAFF = MODEL_HELPER + 72,
    MODEL_GAMBLE_BOW_CROSSBOW = MODEL_HELPER + 73,
    MODEL_GAMBLE_SCEPTER = MODEL_HELPER + 74,
    MODEL_GAMBLE_STICK = MODEL_HELPER + 75,
    MODEL_PANDA_TRANSFORMATION_RING = MODEL_HELPER + 76,
    MODEL_PET_PANDA = MODEL_HELPER + 80,
    MODEL_TALISMAN_OF_GUARDIAN = MODEL_HELPER + 81,
    MODEL_TALISMAN_OF_ITEM_PROTECTION = MODEL_HELPER + 82,
    MODEL_MASTER_SEAL_OF_ASCENSION = MODEL_HELPER + 93,
    MODEL_MASTER_SEAL_OF_WEALTH = MODEL_HELPER + 94,
    MODEL_MAGIC_GLADIATOR_CHARACTER_CARD = MODEL_HELPER + 97,
    MODEL_DARK_LORD_CHARACTER_CARD = MODEL_HELPER + 98,
    MODEL_PARTY_EXP_SCROLL = MODEL_HELPER + 103,
    MODEL_MAX_AG_BOOST_AURA = MODEL_HELPER + 104,
    MODEL_MAX_SD_BOOST_AURA = MODEL_HELPER + 105,
    MODEL_PET_UNICORN = MODEL_HELPER + 106,
    MODEL_LETHAL_WIZARDS_RING = MODEL_HELPER + 107,
    MODEL_SAPPHIRE_RING = MODEL_HELPER + 109,
    MODEL_RUBY_RING = MODEL_HELPER + 110,
    MODEL_TOPAZ_RING = MODEL_HELPER + 111,
    MODEL_AMETHYST_RING = MODEL_HELPER + 112,
    MODEL_RUBY_NECKLACE = MODEL_HELPER + 113,
    MODEL_EMERALD_NECKLACE = MODEL_HELPER + 114,
    MODEL_SAPPHIRE_NECKLACE = MODEL_HELPER + 115,
    MODEL_OPEN_ACCESS_TICKET_TO_CHAOS_CASTLE = MODEL_HELPER + 121,
    MODEL_SKELETON_TRANSFORMATION_RING = MODEL_HELPER + 122,
    MODEL_PET_SKELETON = MODEL_HELPER + 123,
    MODEL_PAID_CHANNEL_ACCESS_TICKET = MODEL_HELPER + 124,
    MODEL_OPEN_ACCESS_TICKET_TO_DOPPELGANGER = MODEL_HELPER + 125,
    MODEL_OPEN_ACCESS_TICKET_TO_VARKA = MODEL_HELPER + 126,
    MODEL_OPEN_ACCESS_TICKET_TO_VARKA_7 = MODEL_HELPER + 127,
    MODEL_FIRST_LUCKY_ARMOR_TICKET = MODEL_HELPER + 135,
    MODEL_FIRST_LUCKY_PANTS_TICKET = MODEL_HELPER + 136,
    MODEL_FIRST_LUCKY_HELM_TICKET = MODEL_HELPER + 137,
    MODEL_FIRST_LUCKY_GLOVES_TICKET = MODEL_HELPER + 138,
    MODEL_FIRST_LUCKY_BOOTS_TICKET = MODEL_HELPER + 139,
    MODEL_SECOND_LUCKY_ARMOR_TICKET = MODEL_HELPER + 140,
    MODEL_SECOND_LUCKY_PANTS_TICKET = MODEL_HELPER + 141,
    MODEL_SECOND_LUCKY_HELM_TICKET = MODEL_HELPER + 142,
    MODEL_SECOND_LUCKY_GLOVES_TICKET = MODEL_HELPER + 143,
    MODEL_SECOND_LUCKY_BOOTS_TICKET = MODEL_HELPER + 144,
    ...
    MODEL_REMEDY_OF_LOVE = MODEL_POTION + 20,
    MODEL_RENA = MODEL_POTION + 21,
    ...
    MODEL_TALISMAN_OF_LUCK = MODEL_POTION + 53,
    MODEL_CHAOS_CARD = MODEL_POTION + 54,
    MODEL_GREEN_CHAOS_BOX = MODEL_POTION + 55,
    MODEL_RED_CHAOS_BOX = MODEL_POTION + 56,
    MODEL_PURPLE_CHAOS_BOX = MODEL_POTION + 57,
    MODEL_RARE_ITEM_TICKET_1 = MODEL_POTION + 58,
    MODEL_RARE_ITEM_TICKET_2 = MODEL_POTION + 59,
    MODEL_RARE_ITEM_TICKET_3 = MODEL_POTION + 60,
    MODEL_RARE_ITEM_TICKET_4 = MODEL_POTION + 61,
    MODEL_RARE_ITEM_TICKET_5 = MODEL_POTION + 62,
    MODEL_FIRECRACKER = MODEL_POTION + 63,
    MODEL_CURSED_CASTLE_WATER = MODEL_POTION + 64,
    ...
    MODEL_ELITE_HEALING_POTION = MODEL_POTION + 70,
    MODEL_ELITE_MANA_POTION = MODEL_POTION + 71,
    MODEL_SCROLL_OF_QUICKNESS = MODEL_POTION + 72,
    MODEL_SCROLL_OF_DEFENSE = MODEL_POTION + 73,
    MODEL_SCROLL_OF_WRATH = MODEL_POTION + 74,
    MODEL_SCROLL_OF_WIZARDRY = MODEL_POTION + 75,
    MODEL_SCROLL_OF_HEALTH = MODEL_POTION + 76,
    MODEL_SCROLL_OF_MANA = MODEL_POTION + 77,
    MODEL_ELIXIR_OF_STRENGTH = MODEL_POTION + 78,
    MODEL_ELIXIR_OF_AGILITY = MODEL_POTION + 79,
    MODEL_ELIXIR_OF_HEALTH = MODEL_POTION + 80,
    MODEL_ELIXIR_OF_ENERGY = MODEL_POTION + 81,
    MODEL_ELIXIR_OF_CONTROL = MODEL_POTION + 82,
    ...
    MODEL_WHITE_CHERRY_BLOSSOM_BRANCH = MODEL_POTION + 88,
    MODEL_RED_CHERRY_BLOSSOM_BRANCH = MODEL_POTION + 89,
    MODEL_GOLDEN_CHERRY_BLOSSOM_BRANCH = MODEL_POTION + 90,
    MODEL_SUMMONER_CHARACTER_CARD = MODEL_POTION + 91,
    MODEL_CHAOS_CARD_GOLD = MODEL_POTION + 92,
    MODEL_CHAOS_CARD_RARE = MODEL_POTION + 93,
    MODEL_MEDIUM_ELITE_HEALING_POTION = MODEL_POTION + 94,
    MODEL_CHAOS_CARD_MINI = MODEL_POTION + 95,
    MODEL_TALISMAN_OF_CHAOS_ASSEMBLY = MODEL_POTION + 96,
    MODEL_SCROLL_OF_BATTLE = MODEL_POTION + 97,
    MODEL_SCROLL_OF_STRENGTH = MODEL_POTION + 98,
    ...
    MODEL_SILVER_KEY = MODEL_POTION + 112,
    MODEL_GOLD_KEY = MODEL_POTION + 113,
    MODEL_MASTER_SKILL_RESET = MODEL_POTION + 114,
    MODEL_STAT_ADJUSTMENT = MODEL_POTION + 115,
    MODEL_CHARACTER_RELOCATION_SERVICE = MODEL_POTION + 116,
    MODEL_CHARACTER_RENAME_SERVICE = MODEL_POTION + 117,
    MODEL_SERVER_RELOCATION_SERVICE = MODEL_POTION + 118,
    MODEL_PREMIUM_PACKAGE = MODEL_POTION + 119,
    MODEL_GOBLIN_GOLD_COIN = MODEL_POTION + 120,
    MODEL_SEALED_GOLDEN_BOX = MODEL_POTION + 121,
    MODEL_SEALED_SILVER_BOX = MODEL_POTION + 122,
    MODEL_GOLDEN_BOX = MODEL_POTION + 123,
    MODEL_SILVER_BOX = MODEL_POTION + 124,
    MODEL_PACKAGE_BOX = MODEL_POTION + 125,
    MODEL_30_DAY_PASS = MODEL_POTION + 126,
    MODEL_90_DAY_PASS = MODEL_POTION + 127,
    MODEL_30_DAY_PASS_POINTS = MODEL_POTION + 128,
    MODEL_90_DAY_PASS_POINTS = MODEL_POTION + 129,
    MODEL_3_HOUR_PASS = MODEL_POTION + 130,
    MODEL_5_HOUR_PASS = MODEL_POTION + 131,
    MODEL_10_HOUR_PASS = MODEL_POTION + 132,
    MODEL_ELITE_SD_POTION = MODEL_POTION + 133,
    MODEL_PACKAGE_BOX_A = MODEL_POTION + 134,
    MODEL_PACKAGE_BOX_B = MODEL_POTION + 135,
    MODEL_PACKAGE_BOX_C = MODEL_POTION + 136,
    MODEL_PACKAGE_BOX_D = MODEL_POTION + 137,
    MODEL_PACKAGE_BOX_E = MODEL_POTION + 138,
    MODEL_PACKAGE_BOX_F = MODEL_POTION + 139,
    MODEL_SCROLL_OF_HEALING = MODEL_POTION + 140,
    MODEL_RARE_ITEM_TICKET_7 = MODEL_POTION + 145,
    MODEL_RARE_ITEM_TICKET_8 = MODEL_POTION + 146,
    MODEL_RARE_ITEM_TICKET_9 = MODEL_POTION + 147,
    MODEL_RARE_ITEM_TICKET_10 = MODEL_POTION + 148,
    MODEL_RARE_ITEM_TICKET_11 = MODEL_POTION + 149,
    MODEL_RARE_ITEM_TICKET_12 = MODEL_POTION + 150,
    MODEL_LV1_LETTER_OF_REQUEST = MODEL_POTION + 151,
    MODEL_LV1_COMPLETION_CERTIFICATE = MODEL_POTION + 152,
    MODEL_STARDUST = MODEL_POTION + 153,
    MODEL_KALT_STONE = MODEL_POTION + 154,
    MODEL_TANTALOS_ARMOR = MODEL_POTION + 155,
    MODEL_BURNT_MURDERERS_CLUB = MODEL_POTION + 156,
...
enum
{
    ...
    ITEM_GEM_OF_SECRET = ITEM_WING + 26,
    ...
    ITEM_SMALL_CAPE_OF_LORD = ITEM_WING + 130,
    ITEM_SMALL_WING_OF_CURSE = ITEM_WING + 131,
    ITEM_SMALL_WINGS_OF_ELF = ITEM_WING + 132,
    ITEM_SMALL_WINGS_OF_HEAVEN = ITEM_WING + 133,
    ITEM_SMALL_WINGS_OF_SATAN = ITEM_WING + 134,
    ITEM_LITTLE_WARRIORS_CLOAK = ITEM_WING + 135,
    ...
    ITEM_CONTRACT_SUMMON = ITEM_HELPER + 7,
    ...
    ITEM_SEAL_OF_ASCENSION = ITEM_HELPER + 43,
    ITEM_SEAL_OF_WEALTH = ITEM_HELPER + 44,
    ITEM_SEAL_OF_SUSTENANCE = ITEM_HELPER + 45,
    ITEM_DEVIL_SQUARE_TICKET = ITEM_HELPER + 46,
    ITEM_BLOOD_CASTLE_TICKET = ITEM_HELPER + 47,
    ITEM_KALIMA_TICKET = ITEM_HELPER + 48,
    ...
    ITEM_RESET_FRUIT_STRENGTH = ITEM_HELPER + 54,
    ITEM_RESET_FRUIT_QUICKNESS = ITEM_HELPER + 55,
    ITEM_RESET_FRUIT_HEALTH = ITEM_HELPER + 56,
    ITEM_RESET_FRUIT_ENERGY = ITEM_HELPER + 57,
    ITEM_RESET_FRUIT_CONTROL = ITEM_HELPER + 58,
    ITEM_SEAL_OF_MOBILITY = ITEM_HELPER + 59,
    ITEM_INDULGENCE = ITEM_HELPER + 60,
    ITEM_ILLUSION_TEMPLE_TICKET = ITEM_HELPER + 61,
    ITEM_SEAL_OF_HEALING = ITEM_HELPER + 62,
    ITEM_SEAL_OF_DIVINITY = ITEM_HELPER + 63,
    ITEM_DEMON = ITEM_HELPER + 64,
    ITEM_SPIRIT_OF_GUARDIAN = ITEM_HELPER + 65,
    ITEM_INVITATION_TO_SANTA_VILLAGE = ITEM_HELPER + 66,
    ITEM_PET_RUDOLF = ITEM_HELPER + 67,
    ITEM_SNOWMAN_TRANSFORMATION_RING = ITEM_HELPER + 68,
    ITEM_TALISMAN_OF_RESURRECTION = ITEM_HELPER + 69,
    ITEM_TALISMAN_OF_MOBILITY = ITEM_HELPER + 70,
    ITEM_GAMBLE_SWORD_MACE_SPEAR = ITEM_HELPER + 71,
    ITEM_GAMBLE_STAFF = ITEM_HELPER + 72,
    ITEM_GAMBLE_BOW_CROSSBOW = ITEM_HELPER + 73,
    ITEM_GAMBLE_SCEPTER = ITEM_HELPER + 74,
    ITEM_GAMBLE_STICK = ITEM_HELPER + 75,
    ITEM_PANDA_TRANSFORMATION_RING = ITEM_HELPER + 76,
    ITEM_PET_PANDA = ITEM_HELPER + 80,
    ITEM_TALISMAN_OF_GUARDIAN = ITEM_HELPER + 81,
    ITEM_TALISMAN_OF_ITEM_PROTECTION = ITEM_HELPER + 82,
    ITEM_MASTER_SEAL_OF_ASCENSION = ITEM_HELPER + 93,
    ITEM_MASTER_SEAL_OF_WEALTH = ITEM_HELPER + 94,
    ITEM_MAGIC_GLADIATOR_CHARACTER_CARD = ITEM_HELPER + 97,
    ITEM_DARK_LORD_CHARACTER_CARD = ITEM_HELPER + 98,
    ITEM_PARTY_EXP_SCROLL = ITEM_HELPER + 103,
    ITEM_MAX_AG_BOOST_AURA = ITEM_HELPER + 104,
    ITEM_MAX_SD_BOOST_AURA = ITEM_HELPER + 105,
    ITEM_PET_UNICORN = ITEM_HELPER + 106,
    ITEM_LETHAL_WIZARDS_RING = ITEM_HELPER + 107,
    ITEM_SAPPHIRE_RING = ITEM_HELPER + 109,
    ITEM_RUBY_RING = ITEM_HELPER + 110,
    ITEM_TOPAZ_RING = ITEM_HELPER + 111,
    ITEM_AMETHYST_RING = ITEM_HELPER + 112,
    ITEM_RUBY_NECKLACE = ITEM_HELPER + 113,
    ITEM_EMERALD_NECKLACE = ITEM_HELPER + 114,
    ITEM_SAPPHIRE_NECKLACE = ITEM_HELPER + 115,
    ITEM_OPEN_ACCESS_TICKET_TO_CHAOS_CASTLE = ITEM_HELPER + 121,
    ITEM_SKELETON_TRANSFORMATION_RING = ITEM_HELPER + 122,
    ITEM_PET_SKELETON = ITEM_HELPER + 123,
    ITEM_PAID_CHANNEL_ACCESS_TICKET = ITEM_HELPER + 124,
    ITEM_OPEN_ACCESS_TICKET_TO_DOPPELGANGER = ITEM_HELPER + 125,
    ITEM_OPEN_ACCESS_TICKET_TO_VARKA = ITEM_HELPER + 126,
    ITEM_OPEN_ACCESS_TICKET_TO_VARKA_7 = ITEM_HELPER + 127,
    ITEM_FIRST_LUCKY_ARMOR_TICKET = ITEM_HELPER + 135,
    ITEM_FIRST_LUCKY_PANTS_TICKET = ITEM_HELPER + 136,
    ITEM_FIRST_LUCKY_HELM_TICKET = ITEM_HELPER + 137,
    ITEM_FIRST_LUCKY_GLOVES_TICKET = ITEM_HELPER + 138,
    ITEM_FIRST_LUCKY_BOOTS_TICKET = ITEM_HELPER + 139,
    ITEM_SECOND_LUCKY_ARMOR_TICKET = ITEM_HELPER + 140,
    ITEM_SECOND_LUCKY_PANTS_TICKET = ITEM_HELPER + 141,
    ITEM_SECOND_LUCKY_HELM_TICKET = ITEM_HELPER + 142,
    ITEM_SECOND_LUCKY_GLOVES_TICKET = ITEM_HELPER + 143,
    ITEM_SECOND_LUCKY_BOOTS_TICKET = ITEM_HELPER + 144,
    ...
    ITEM_REMEDY_OF_LOVE = ITEM_POTION + 20,
    ITEM_RENA = ITEM_POTION + 21,
    ...
    ITEM_TALISMAN_OF_LUCK = ITEM_POTION + 53,
    ITEM_CHAOS_CARD = ITEM_POTION + 54,
    ITEM_GREEN_CHAOS_BOX = ITEM_POTION + 55,
    ITEM_RED_CHAOS_BOX = ITEM_POTION + 56,
    ITEM_PURPLE_CHAOS_BOX = ITEM_POTION + 57,
    ITEM_RARE_ITEM_TICKET_1 = ITEM_POTION + 58,
    ITEM_RARE_ITEM_TICKET_2 = ITEM_POTION + 59,
    ITEM_RARE_ITEM_TICKET_3 = ITEM_POTION + 60,
    ITEM_RARE_ITEM_TICKET_4 = ITEM_POTION + 61,
    ITEM_RARE_ITEM_TICKET_5 = ITEM_POTION + 62,
    ITEM_FIRECRACKER = ITEM_POTION + 63,
    ITEM_CURSED_CASTLE_WATER = ITEM_POTION + 64,
    ...
    ITEM_ELITE_HEALING_POTION = ITEM_POTION + 70,
    ITEM_ELITE_MANA_POTION = ITEM_POTION + 71,
    ITEM_SCROLL_OF_QUICKNESS = ITEM_POTION + 72,
    ITEM_SCROLL_OF_DEFENSE = ITEM_POTION + 73,
    ITEM_SCROLL_OF_WRATH = ITEM_POTION + 74,
    ITEM_SCROLL_OF_WIZARDRY = ITEM_POTION + 75,
    ITEM_SCROLL_OF_HEALTH = ITEM_POTION + 76,
    ITEM_SCROLL_OF_MANA = ITEM_POTION + 77,
    ITEM_ELIXIR_OF_STRENGTH = ITEM_POTION + 78,
    ITEM_ELIXIR_OF_AGILITY = ITEM_POTION + 79,
    ITEM_ELIXIR_OF_HEALTH = ITEM_POTION + 80,
    ITEM_ELIXIR_OF_ENERGY = ITEM_POTION + 81,
    ITEM_ELIXIR_OF_CONTROL = ITEM_POTION + 82,
    ...
    ITEM_WHITE_CHERRY_BLOSSOM_BRANCH = ITEM_POTION + 88,
    ITEM_RED_CHERRY_BLOSSOM_BRANCH = ITEM_POTION + 89,
    ITEM_GOLDEN_CHERRY_BLOSSOM_BRANCH = ITEM_POTION + 90,
    ITEM_SUMMONER_CHARACTER_CARD = ITEM_POTION + 91,
    ITEM_CHAOS_CARD_GOLD = ITEM_POTION + 92,
    ITEM_CHAOS_CARD_RARE = ITEM_POTION + 93,
    ITEM_MEDIUM_ELITE_HEALING_POTION = ITEM_POTION + 94,
    ITEM_CHAOS_CARD_MINI = ITEM_POTION + 95,
    ITEM_TALISMAN_OF_CHAOS_ASSEMBLY = ITEM_POTION + 96,
    ITEM_SCROLL_OF_BATTLE = ITEM_POTION + 97,
    ITEM_SCROLL_OF_STRENGTH = ITEM_POTION + 98,
    ...
    ITEM_SILVER_KEY = ITEM_POTION + 112,
    ITEM_GOLD_KEY = ITEM_POTION + 113,
    ITEM_MASTER_SKILL_RESET = ITEM_POTION + 114,
    ITEM_STAT_ADJUSTMENT = ITEM_POTION + 115,
    ITEM_CHARACTER_RELOCATION_SERVICE = ITEM_POTION + 116,
    ITEM_CHARACTER_RENAME_SERVICE = ITEM_POTION + 117,
    ITEM_SERVER_RELOCATION_SERVICE = ITEM_POTION + 118,
    ITEM_PREMIUM_PACKAGE = ITEM_POTION + 119,
    ITEM_GOBLIN_GOLD_COIN = ITEM_POTION + 120,
    ITEM_SEALED_GOLDEN_BOX = ITEM_POTION + 121,
    ITEM_SEALED_SILVER_BOX = ITEM_POTION + 122,
    ITEM_GOLDEN_BOX = ITEM_POTION + 123,
    ITEM_SILVER_BOX = ITEM_POTION + 124,
    ITEM_PACKAGE_BOX = ITEM_POTION + 125,
    ITEM_30_DAY_PASS = ITEM_POTION + 126,
    ITEM_90_DAY_PASS = ITEM_POTION + 127,
    ITEM_30_DAY_PASS_POINTS = ITEM_POTION + 128,
    ITEM_90_DAY_PASS_POINTS = ITEM_POTION + 129,
    ITEM_3_HOUR_PASS = ITEM_POTION + 130,
    ITEM_5_HOUR_PASS = ITEM_POTION + 131,
    ITEM_10_HOUR_PASS = ITEM_POTION + 132,
    ITEM_ELITE_SD_POTION = ITEM_POTION + 133,
    ITEM_PACKAGE_BOX_A = ITEM_POTION + 134,
    ITEM_PACKAGE_BOX_B = ITEM_POTION + 135,
    ITEM_PACKAGE_BOX_C = ITEM_POTION + 136,
    ITEM_PACKAGE_BOX_D = ITEM_POTION + 137,
    ITEM_PACKAGE_BOX_E = ITEM_POTION + 138,
    ITEM_PACKAGE_BOX_F = ITEM_POTION + 139,
    ITEM_SCROLL_OF_HEALING = ITEM_POTION + 140,
    ITEM_RARE_ITEM_TICKET_7 = ITEM_POTION + 145,
    ITEM_RARE_ITEM_TICKET_8 = ITEM_POTION + 146,
    ITEM_RARE_ITEM_TICKET_9 = ITEM_POTION + 147,
    ITEM_RARE_ITEM_TICKET_10 = ITEM_POTION + 148,
    ITEM_RARE_ITEM_TICKET_11 = ITEM_POTION + 149,
    ITEM_RARE_ITEM_TICKET_12 = ITEM_POTION + 150,
    ITEM_LV1_LETTER_OF_REQUEST = ITEM_POTION + 151,
    ITEM_LV1_COMPLETION_CERTIFICATE = ITEM_POTION + 152,
    ITEM_STARDUST = ITEM_POTION + 153,
    ITEM_KALT_STONE = ITEM_POTION + 154,
    ITEM_TANTALOS_ARMOR = ITEM_POTION + 155,
    ITEM_BURNT_MURDERERS_CLUB = ITEM_POTION + 156,
