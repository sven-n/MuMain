...
void CNewUIMuHelper::InitButtons()
{
    ...
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 191, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_SKILL2_CONFIG, 0); //-- skill 2
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 243, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_SKILL3_CONFIG, 0); //-- skill 3
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 84, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_POTION_CONFIG_ELF, 0); //-- Buff
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 79, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_POTION_CONFIG_SUMMY, 0); //-- potion
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 84, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_POTION_CONFIG, 0); //-- potion
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 17, m_Pos.y + 234, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_PARTY_CONFIG, 0); //-- potion
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 17, m_Pos.y + 234, 38, 24, 1, 0, 1, 1, I18N::Game::Setting, L"", BUTTON_ID_PARTY_CONFIG_ELF, 0); //-- potion
    ...
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 208, 38, 24, 1, 0, 1, 1, I18N::Game::Add, L"", BUTTON_ID_ADD_OTHER_ITEM, 1); //-- Buff
    InsertButton(IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 309, 38, 24, 1, 0, 1, 1, I18N::Game::Delete, L"", BUTTON_ID_DELETE_OTHER_ITEM, 1); //-- Buff
    //--
