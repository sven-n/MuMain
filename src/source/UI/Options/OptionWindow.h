...
namespace mu::ui::window
{
    ...
    private:
        ...
        // RmlUi's native <select>) -- dropdownId is 0=resolution,1=fpsCap,2=theme,3=language,
        // 4=font,5=uiScale, matching model.openDropdown's own comment (OptionWindow.h).
        // RmlDropdownOptionClick
