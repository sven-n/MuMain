...
bool CNewUIPetInfoWindow::Render()
{
    ...
    case TAB_TYPE_DARKHORSE:
    {
        ...
        if (pPetInfo->m_dwPetType == PET_TYPE_NONE)
        {
            ...
            wsprintf(szText, GlobalText[1233], GlobalText[1187]);
...
bool CNewUIPetInfoWindow::RenderDarkHorseInfo(PET_INFO* pPetInfo)
{
    ...
    wsprintf(szText, GlobalText[200], pPetInfo->m_wLevel);
    g_pRenderText->RenderText(iPosX + 2, iPosY + 8, szText, 70 - 14, 0, RT3_SORT_CENTER);

    g_pRenderText->SetFont(g_hFont);
    g_pRenderText->SetTextColor(255, 255, 255, 255);

    wsprintf(szText, GlobalText[358], pPetInfo->m_wLife, 255);
    ...
    wsprintf(szText, GlobalText[357], pPetInfo->m_dwExp1, pPetInfo->m_dwExp2);
    g_pRenderText->RenderText(iPosX + 10, iPosY + 59, szText, 0, 0, RT3_SORT_CENTER);
    wsprintf(szText, GlobalText[203], m_aiDamage[0], m_aiDamage[1], pPetInfo->m_wAttackSuccess);
    g_pRenderText->RenderText(iPosX + 10, iPosY + 72, szText, 0, 0, RT3_SORT_CENTER);
    wsprintf(szText, GlobalText[64], pPetInfo->m_wAttackSpeed);
...
bool CNewUIPetInfoWindow::RenderDarkSpiritInfo(PET_INFO* pPetInfo)
{
    ...
    wsprintf(szText, GlobalText[203], m_aiDamage[0], m_aiDamage[1],
    ...
    wsprintf(szText, GlobalText[698], (185 + (pPetInfo->m_wLevel * 15)));
