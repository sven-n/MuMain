...
enum EMonsterModelType : int
{
    ...
    MONSTER_MODEL_BALROG_ = 27,
    MONSTER_MODEL_SHADOW_ = 28,
    MONSTER_MODEL_DEATH_KNIGHT_ = 29,
    MONSTER_MODEL_DEATH_COW = 30,
    MONSTER_MODEL_DRAGON = 31,
    MONSTER_MODEL_BALI_ = 32,
    ...
    MONSTER_MODEL_SOLDIER_ = 40,
    MONSTER_MODEL_GOLDEN_WHEEL_ = 41,
    MONSTER_MODEL_TANTALLOS = 42,
    MONSTER_MODEL_BLOODY_WOLF = 43,
    MONSTER_MODEL_BEAM_KNIGHT = 44,
    MONSTER_MODEL_MUTANT_ = 45,
    MONSTER_MODEL_ORC_ARCHER = 46,
    MONSTER_MODEL_ORC = 47,
    MONSTER_MODEL_CURSED_KING_ = 48,
    MONSTER_MODEL_MOLT_ = 49,
    MONSTER_MODEL_ALQUAMOS_ = 50,
    MONSTER_MODEL_QUEEN_RAINER = 51,
    MONSTER_MODEL_CRUST = 52,
    MONSTER_MODEL_PHANTOM_KNIGHT = 53,
    MONSTER_MODEL_DRAKAN_ = 54,
    MONSTER_MODEL_DARK_PHOENIX_SHIELD_ = 55,
    MONSTER_MODEL_DARK_PHOENIX_ = 56,
    ...
    MONSTER_MODEL_CASTLE_GATE1_ = 73,
    MONSTER_MODEL_GUARDIAN_STATUE_ = 74,
    MONSTER_MODEL_GREAT_DRAKAN = 75,
    MONSTER_MODEL_BATTLE_GUARD1_ = 76,
    MONSTER_MODEL_BATTLE_GUARD2_ = 77,
    MONSTER_MODEL_GOLDEN_GOBLIN = 78,
    MONSTER_MODEL_CANON_TOWER_ = 79,
    MONSTER_MODEL_GOLDEN_LIZARD_KING = 80,
    MONSTER_MODEL_LIZARD_WARRIOR_ = 81,
    MONSTER_MODEL_FIRE_GOLEM_ = 82,
    MONSTER_MODEL_QUEEN_BEE_ = 83,
    MONSTER_MODEL_POISON_GOLEM_ = 84,
    MONSTER_MODEL_AXE_HERO_ = 85,
    MONSTER_MODEL_LIFE_STONE_ = 86,
    MONSTER_MODEL_EROHIM_ = 87,
    MONSTER_MODEL_RED_SKELETON_KNIGHT_1 = 88,
    MONSTER_MODEL_BALGASS_ = 89,
    MONSTER_MODEL_CHIEF_SKELETON_WARRIOR_2 = 90,
    MONSTER_MODEL_BALRAM_ = 91,
    MONSTER_MODEL_DARK_ELF_1 = 92,
    MONSTER_MODEL_DEATH_SPIRIT_ = 93,
    MONSTER_MODEL_SORAM_ = 94,
    MONSTER_MODEL_WEREWOLF_HERO = 95,
    MONSTER_MODEL_VALAM_ = 96,
    MONSTER_MODEL_SOLAM_ = 97,
    MONSTER_MODEL_SCOUT = 98,
    MONSTER_MODEL_BALLISTA_ = 99,
    MONSTER_MODEL_WITCH_QUEEN_ = 100,
    MONSTER_MODEL_GOLDEN_STONE_GOLEM_ = 101,
    MONSTER_MODEL_DEATH_RIDER_ = 102,
    MONSTER_MODEL_FOREST_ORC_ = 103,
    MONSTER_MODEL_DEATH_TREE = 104,
    MONSTER_MODEL_HELL_MAINE_ = 105,
    MONSTER_MODEL_BERSERK = 106,
    MONSTER_MODEL_SPLINTER_WOLF_ = 107,
    MONSTER_MODEL_IRON_RIDER_ = 108,
    MONSTER_MODEL_SATYROS_ = 109,
    MONSTER_MODEL_BLADE_HUNTER = 110,
    MONSTER_MODEL_KENTAUROS = 111,
    MONSTER_MODEL_GIGANTIS_ = 112,
    MONSTER_MODEL_GENOCIDER_ = 113,
    ...
    MONSTER_MODEL_DARK_ELF_ = 126,
    MONSTER_MODEL_LUNAR_RABBIT_ = 127,
    MONSTER_MODEL_RABBIT_ = 128,
    MONSTER_MODEL_BUTTERFLY_ = 129,
    MONSTER_MODEL_HIDEOUS_RABBIT_ = 130,
    MONSTER_MODEL_WEREWOLF2_ = 131,
    MONSTER_MODEL_CURSED_LICH_ = 132,
    MONSTER_MODEL_TOTEM_GOLEM_ = 133,
    MONSTER_MODEL_GRIZZLY_ = 134,
    MONSTER_MODEL_CAPTAIN_GRIZZLY_ = 135,
    ...
    MONSTER_MODEL_CURSED_SANTA_ = 155,
    MONSTER_MODEL_EVIL_GOBLIN_ = 156,
    ...
    MONSTER_MODEL_JERRY_ = 165,
    MONSTER_MODEL_RAYMOND_ = 166,
    MONSTER_MODEL_LUCAS_ = 167,
    MONSTER_MODEL_FRED_ = 168,
    MONSTER_MODEL_HAMMERIZE_ = 169,
    MONSTER_MODEL_DUAL_BERSERKER_ = 170,
    MONSTER_MODEL_DEVIL_LORD_ = 171,
    MONSTER_MODEL_QUARTER_MASTER_ = 172,
    MONSTER_MODEL_COMBAT_INSTRUCTOR_ = 173,
    MONSTER_MODEL_ATICLES_HEAD_ = 174,
    MONSTER_MODEL_DARK_GHOST_ = 175,
    MONSTER_MODEL_BANSHEE_ = 176,
    MONSTER_MODEL_HEAD_MOUNTER_ = 177,
    MONSTER_MODEL_DEFENDER_ = 178,
    MONSTER_MODEL_FORSAKER_ = 179,
    MONSTER_MODEL_OCELOT = 180,
    MONSTER_MODEL_ERIC = 181,
    MONSTER_MODEL_DEATH_ANGEL_3 = 182,
    MONSTER_MODEL_EVIL_GATE_ = 183,
    MONSTER_MODEL_LION_GATE_ = 184,
    MONSTER_MODEL_STATUE_ = 185,
    MONSTER_MODEL_STAR_GATE_ = 186,
    MONSTER_MODEL_RUSH_GATE_ = 187,
    ...
    MONSTER_MODEL_BLOODY_ORC_ = 193,
    MONSTER_MODEL_BLOODY_DEATH_RIDER_ = 194,
    MONSTER_MODEL_BLOODY_GOLEM_ = 195,
    MONSTER_MODEL_BLOODY_WITCH_QUEEN_ = 196,
...
enum
{
    ...
    MODEL_GOBLIN_ = MODEL_MONSTER01 + 19,
    ...
    MODEL_BALROG_ = MODEL_MONSTER01 + 27,
    MODEL_SHADOW_ = MODEL_MONSTER01 + 28,
    MODEL_DEATH_KNIGHT_ = MODEL_MONSTER01 + 29,
    MODEL_DEATH_COW = MODEL_MONSTER01 + 30,
    MODEL_DRAGON_ = MODEL_MONSTER01 + 31,
    MODEL_BALI_ = MODEL_MONSTER01 + 32,
    ...
    MODEL_SOLDIER_ = MODEL_MONSTER01 + 40,
    MODEL_GOLDEN_WHEEL_ = MODEL_MONSTER01 + 41,
    MODEL_TANTALLOS = MODEL_MONSTER01 + 42,
    MODEL_BLOODY_WOLF = MODEL_MONSTER01 + 43,
    MODEL_BEAM_KNIGHT = MODEL_MONSTER01 + 44,
    MODEL_MUTANT_ = MODEL_MONSTER01 + 45,
    MODEL_ORC_ARCHER_ = MODEL_MONSTER01 + 46,
    MODEL_ORC = MODEL_MONSTER01 + 47,
    MODEL_CURSED_KING_ = MODEL_MONSTER01 + 48,
    MODEL_MOLT_ = MODEL_MONSTER01 + 49,
    MODEL_ALQUAMOS_ = MODEL_MONSTER01 + 50,
    MODEL_QUEEN_RAINER = MODEL_MONSTER01 + 51,
    MODEL_CRUST = MODEL_MONSTER01 + 52,
    MODEL_PHANTOM_KNIGHT_ = MODEL_MONSTER01 + 53,
    MODEL_DRAKAN_ = MODEL_MONSTER01 + 54,
    ...
    MODEL_CHAOSCASTLE_ELF = MODEL_MONSTER01 + 71,
    MODEL_PHANTOM_KNIGHT = MODEL_MONSTER01 + 72,
    MODEL_CASTLE_GATE1_ = MODEL_MONSTER01 + 73,
    MODEL_GUARDIAN_STATUE_ = MODEL_MONSTER01 + 74,
    MODEL_GREAT_DRAKAN = MODEL_MONSTER01 + 75,
    MODEL_BATTLE_GUARD1_ = MODEL_MONSTER01 + 76,
    MODEL_BATTLE_GUARD2_ = MODEL_MONSTER01 + 77,
    MODEL_GOLDEN_GOBLIN = MODEL_MONSTER01 + 78,
    MODEL_CANON_TOWER_ = MODEL_MONSTER01 + 79,
    MODEL_GOLDEN_LIZARD_KING = MODEL_MONSTER01 + 80,
    MODEL_LIZARD_WARRIOR_ = MODEL_MONSTER01 + 81,
    MODEL_FIRE_GOLEM_ = MODEL_MONSTER01 + 82,
    MODEL_QUEEN_BEE_ = MODEL_MONSTER01 + 83,
    MODEL_POISON_GOLEM_ = MODEL_MONSTER01 + 84,
    MODEL_AXE_HERO_ = MODEL_MONSTER01 + 85,
    MODEL_LIFE_STONE_ = MODEL_MONSTER01 + 86,
    MODEL_EROHIM_ = MODEL_MONSTER01 + 87,
    MODEL_RED_SKELETON_KNIGHT_1 = MODEL_MONSTER01 + 88,
    MODEL_BALGASS_ = MODEL_MONSTER01 + 89,
    MODEL_CHIEF_SKELETON_WARRIOR_2 = MODEL_MONSTER01 + 90,
    MODEL_BALRAM_ = MODEL_MONSTER01 + 91,
    MODEL_DARK_ELF_1 = MODEL_MONSTER01 + 92,
    MODEL_DEATH_SPIRIT = MODEL_MONSTER01 + 93,
    MODEL_SORAM_ = MODEL_MONSTER01 + 94,
    MODEL_WEREWOLF_HERO = MODEL_MONSTER01 + 95,
    MODEL_VALAM_ = MODEL_MONSTER01 + 96,
    MODEL_SOLAM_ = MODEL_MONSTER01 + 97,
    MODEL_SCOUT = MODEL_MONSTER01 + 98,
    MODEL_BALLISTA_ = MODEL_MONSTER01 + 99,
    MODEL_WITCH_QUEEN_ = MODEL_MONSTER01 + 100,
    MODEL_GOLDEN_STONE_GOLEM_ = MODEL_MONSTER01 + 101,
    MODEL_DEATH_RIDER_ = MODEL_MONSTER01 + 102,
    MODEL_FOREST_ORC_ = MODEL_MONSTER01 + 103,
    MODEL_DEATH_TREE = MODEL_MONSTER01 + 104,
    MODEL_HELL_MAINE_ = MODEL_MONSTER01 + 105,
    MODEL_BERSERK = MODEL_MONSTER01 + 106,
    MODEL_SPLINTER_WOLF_ = MODEL_MONSTER01 + 107,
    MODEL_IRON_RIDER_ = MODEL_MONSTER01 + 108,
    MODEL_SATYROS_ = MODEL_MONSTER01 + 109,
    MODEL_BLADE_HUNTER = MODEL_MONSTER01 + 110,
    MODEL_KENTAUROS = MODEL_MONSTER01 + 111,
    MODEL_GIGANTIS_ = MODEL_MONSTER01 + 112,
    MODEL_GENOCIDER_ = MODEL_MONSTER01 + 113,
    ...
    MODEL_DARK_ELF_ = MODEL_MONSTER01 + 126,
    MODEL_LUNAR_RABBIT_ = MODEL_MONSTER01 + 127,
    MODEL_RABBIT_ = MODEL_MONSTER01 + 128,
    MODEL_BUTTERFLY_ = MODEL_MONSTER01 + 129,
    MODEL_HIDEOUS_RABBIT_ = MODEL_MONSTER01 + 130,
    MODEL_WEREWOLF2_ = MODEL_MONSTER01 + 131,
    MODEL_CURSED_LICH_ = MODEL_MONSTER01 + 132,
    MODEL_TOTEM_GOLEM_ = MODEL_MONSTER01 + 133,
    MODEL_GRIZZLY_ = MODEL_MONSTER01 + 134,
    ...
    MODEL_CURSED_SANTA_ = MODEL_MONSTER01 + 155,
    MODEL_EVIL_GOBLIN_ = MODEL_MONSTER01 + 156,
    ...
    MODEL_JERRY_ = MODEL_MONSTER01 + 165,
    MODEL_RAYMOND_ = MODEL_MONSTER01 + 166,
    MODEL_LUCAS_ = MODEL_MONSTER01 + 167,
    MODEL_FRED_ = MODEL_MONSTER01 + 168,
    MODEL_HAMMERIZE_ = MODEL_MONSTER01 + 169,
    MODEL_DUAL_BERSERKER_ = MODEL_MONSTER01 + 170,
    MODEL_DEVIL_LORD_ = MODEL_MONSTER01 + 171,
    MODEL_QUARTER_MASTER_ = MODEL_MONSTER01 + 172,
    MODEL_COMBAT_INSTRUCTOR_ = MODEL_MONSTER01 + 173,
    MODEL_ATICLES_HEAD_ = MODEL_MONSTER01 + 174,
    MODEL_DARK_GHOST_ = MODEL_MONSTER01 + 175,
    MODEL_BANSHEE_ = MODEL_MONSTER01 + 176,
    MODEL_HEAD_MOUNTER_ = MODEL_MONSTER01 + 177,
    MODEL_DEFENDER_ = MODEL_MONSTER01 + 178,
    MODEL_FORSAKER_ = MODEL_MONSTER01 + 179,
    MODEL_OCELOT = MODEL_MONSTER01 + 180,
    MODEL_ERIC = MODEL_MONSTER01 + 181,
    MODEL_DEATH_ANGEL_3 = MODEL_MONSTER01 + 182,
    MODEL_EVIL_GATE_ = MODEL_MONSTER01 + 183,
    MODEL_LION_GATE_ = MODEL_MONSTER01 + 184,
    MODEL_STATUE = MODEL_MONSTER01 + 185,
    MODEL_STAR_GATE_ = MODEL_MONSTER01 + 186,
    MODEL_RUSH_GATE_ = MODEL_MONSTER01 + 187,
    ...
    MODEL_BLOODY_ORC_ = MODEL_MONSTER01 + 193,
    MODEL_BLOODY_DEATH_RIDER_ = MODEL_MONSTER01 + 194,
    MODEL_BLOODY_GOLEM_ = MODEL_MONSTER01 + 195,
    MODEL_BLOODY_WITCH_QUEEN_ = MODEL_MONSTER01 + 196,
