...
typedef void(CORECLR_DELEGATE_CALLTYPE* SendConnectionInfo)(int32_t, char* , uint32_t, uint16_t );
...
typedef void(CORECLR_DELEGATE_CALLTYPE* SendClientNeedsPatch)(int32_t, BYTE , char* , uint32_t);
