...
int32_t CMultiLanguage::ConvertFromUtf8(wchar_t* target, char* source)
{
...
int32_t CMultiLanguage::ConvertToUtf8(char* target, wchar_t* source)
{
    auto count = WideCharToMultiByte(0, 0, source, -1, 0, 0, 0, 0);
