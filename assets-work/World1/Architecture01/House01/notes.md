# House01 — Flat-roof stone house with chimney, timber beams and carved doorway
...
Identity and placement: Flat-roof stone house with chimney, timber beams and carved doorway; 2 unchanged World1 placements. Actual coordinates, rotations, scales and tile coordinates are retained in `original/placements.json`.

Geometry: 176 → 208 triangles. 4 selected panel interiors gain narrow beveled recesses 0.25–0.65 units deep. All original perimeter corners, openings, roof edges and footings remain in place. Footprints, origins, orientation and modular boundaries are unchanged. `validation/blender.json` identifies every modified face pair and original perimeter. High-poly bevel candidates are retained for editing only, excluded from game export.

Material slot order: tile_ston05.jpg, tile_ston04.jpg, tile_house01.jpg, tile_ston06.jpg.
...
- `tile_ston05.jpg`: [512, 512], RGB
- `tile_ston06.jpg`: [128, 128], RGB

Frozen dependency containers, copied unchanged for self-contained review: tile_ston06.OZJ, tile_ston04.OZJ.
...
Bind bounds before: `[[-222.34, -301.18, -0.62], [213.05, 302.26, 314.6]]`.
Bind bounds after: `[[-222.34, -301.18, -0.62], [213.05, 302.26, 314.6]]`.
Every original vertex and bone assignment retained within 0.000000000 units. 168 protected triangles preserve positions and UVs. Maximum unchanged UV component delta: 0. Maximum protected normal component delta: 0.000000000; direction delta: 0.00000000 degrees.

Rig: `['Box28', 'Bone01']`. Names, order, indices and parents exactly retained, together with one action and 1 keys plus original lock metadata. All local bind/action translations and Euler components are checked, not just key counts: `[{'file': 'House01.smd', 'bone_samples': 2, 'frames': 1, 'max_position_component': 0, 'max_euler_component_radians': 0}, {'file': 'House01_a00.smd', 'bone_samples': 2, 'frames': 1, 'max_position_component': 0, 'max_euler_component_radians': 0}]`. Skeleton plus actual action compare EQUIVALENT. Full model DIFFERENT because geometry was remodeled; no full-equivalence claim.
...
UV range retained: U `[-1.1946, 2.1946]`, V `[-1.4867, 2.6339]`. New UVs interpolate inside existing panel islands. Export has finite vertices/UVs, one original full-weight non-dummy bone per corner, original material order and unchanged texture names. Opaque images remain RGB; awning TGA is bottom-left uncompressed 32-bit RGBA with original alpha retained exactly. All OZJ/OZT wrappers pass mu_texture checks.
