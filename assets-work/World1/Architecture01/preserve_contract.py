...
Source Tools' quaternion/Euler conversion slightly perturbs House04's 40-key clip.
...
NAMES = ('House01', 'House03', 'House04', 'Tent01', 'HouseWall02')
...
def protected_mesh(folder, baseline, mesh):
    ...
    (folder / 'validation/protected-packaging.json').write_text(json.dumps(dict(
        restored_original_triangles=restored, official_authored_triangles=len(available),
