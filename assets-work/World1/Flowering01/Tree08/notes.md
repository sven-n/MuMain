...
World1 type 7, 8 placements; exact records in `placements.json`.
Game file: `src/bin/Data/Object1/Tree08.bmd`.
Complete texture dependencies: {'tree_01.jpg': ['src/bin/Data/Object1/tree_01.OZJ']}.
Original mesh/material order: ['tree_01.jpg'].

Geometry retained: 176 triangles, 1 meshes, 1 bones.
...
Texture dimensions: {'tree_01.jpg': [512, 256]}.
Bind bounds before: [[-125.59, -313.86, -2.86], [41.31, 281.9, 84.69]].
Bind bounds after: [[-125.59, -313.86, -2.86], [41.31, 281.9, 84.69]].

Full converter comparison:

```
meshes 1 vs 1, bones 1 vs 1, actions 1 vs 1, triangles 176 vs 176
unmatched triangles: 0  max corner distance: 0.0004  max bone distance: 0.0000  differing bone names: 0
EQUIVALENT
```
