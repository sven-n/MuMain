...
World1 type 12, 4 placements; exact records in `placements.json`.
Game file: `src/bin/Data/Object1/Tree13.bmd`.
Complete texture dependencies: {'tree_05.tga': ['src/bin/Data/Object1/tree_05.OZT'], 'tree_01.jpg': ['src/bin/Data/Object1/tree_01.OZJ']}.
Original mesh/material order: ['tree_05.tga', 'tree_01.jpg'].

Geometry retained: 393 triangles, 2 meshes, 10 bones.
...
Texture dimensions: {'tree_05.tga': [512, 512], 'tree_01.jpg': [512, 256]}.
Bind bounds before: [[-203.43, -203.05, 0.39], [248.12, 194.01, 472.28]].
Bind bounds after: [[-203.43, -203.05, 0.39], [248.12, 194.01, 472.28]].

Full converter comparison:

```
meshes 2 vs 2, bones 10 vs 10, actions 1 vs 1, triangles 393 vs 393
