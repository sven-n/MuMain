# Grass02 — spread low ivy/bramble leaf mat
...
World1 model type 21; 184 actual placements.
The exact placement records, tile coordinates, scales and rotations are in `placements.json`.
Game BMD: `src/bin/Data/Object1/Grass02.bmd`.
Complete texture dependency: `src/bin/Data/Object1/tree_08.OZT` (material `tree_08.tga`).
...
Triangles: 120 before and after. One mesh. Texture: 512×512.
Bind bounds before: [[-253.83, -269.85, -0.54], [252.41, 215.51, 28.38]].
Bind bounds after: [[-253.83, -269.85, -0.54], [252.41, 215.5, 28.38]].

Full BMD comparison: EQUIVALENT; all original triangles match. Full output:

```
meshes 1 vs 1, bones 5 vs 5, actions 1 vs 1, triangles 120 vs 120
unmatched triangles: 0  max corner distance: 0.0002  max bone distance: 0.0000  differing bone names: 0
EQUIVALENT
```
