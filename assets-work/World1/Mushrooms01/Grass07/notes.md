# Grass07 — 7-mushroom woodland cluster

ASTRA coordinator / codex/lorencia-mushrooms. 35 World1 placements.
Material: mushroom.jpg → src/bin/Data/Object1/mushroom.OZJ, shared only with Grass07/08.

Rebuilt rounded red/burgundy caps and fibrous ivory stems: 126 → 1162 triangles.
One mesh/material; 512×512 RGB atlas, opaque JPEG/OZJ, no alpha or added render flags.
Original 7 rigid bones, names/order/parents, one action at index0, one key, lock0 retained.

Bind bounds before: [[-59.39, -44.41, -0.4], [56.12, 58.59, 29.01]]; after: [[-59.39, -44.41, -0.4], [56.12, 58.59, 29.01]]. Source bounds for every individual mushroom
...
0.00000400 units and no Euler rotation difference.
...
Originals: original/Grass07.bmd, info.txt, packed imported source.blend; original action/model SMDs
...
Editable/raw art and prompt are at batch root. Final game export is exports/Grass07.bmd.
