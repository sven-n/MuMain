# Hanging01 — timber gallows platform with stairs and swaying rope/noose
...
Triangles 162 → 338. Full comparison: DIFFERENT (intentional remodel). Skeleton/actions EQUIVALENT:
bone names, order, parents, action order/count, frames and lock flags unchanged. Every local key
is checked by position and Rz*Ry*Rx rotation matrix. Original action metadata ['action 0 keys=25 lock=0'].

Bind bounds before [[-100.94, -98.34, -0.34], [200.18, 111.74, 423.89]]; after [[-100.94, -98.34, -0.34], [200.18, 111.74, 423.89]].
Every original material/bone AABB remains within .005 units. All 25 action keys retain
posed bounds within 0.00001600 units. Original origin/orientation retained.
Authored source→actual exported vertex and intended bone audit max deviation
0.00003060 units. Retained timber,
contacts, platforms, steps and rope preserve all original UVs within .000002 and positions within .005.

Mesh/material order: horse_drawn_01.jpg.
Full dependencies: horse_drawn_01.OZJ. Dimensions {'horse_drawn_01.jpg': [1024, 1024]}.
...
Collapsed UV triangles: 16 before,
16 after; any are existing readonly constant-color caps,
