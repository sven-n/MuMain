# Carriage01 — two-wheeled passenger cart with lantern

Owner `/root/groundcover`, branch `codex/lorencia-cannons`. 4 unchanged World1 placements;
...
Triangles 472 → 472. Full comparison: EQUIVALENT; actual BMD bytes unchanged. Skeleton/actions EQUIVALENT:
bone names, order, parents, action order/count, frames and lock flags unchanged. Every local key
is checked by position and Rz*Ry*Rx rotation matrix. Original action metadata ['action 0 keys=21 lock=0'].

Bind bounds before [[-114.62, -94.23, -14.5], [244.57, 92.68, 201.91]]; after [[-114.62, -94.23, -14.5], [244.57, 92.68, 201.91]].
Every original material/bone AABB remains within .005 units. All 21 action keys retain
...
Mesh/material order: horse_drawn_01.jpg, horse_drawn_02.tga, horse_drawn_03.jpg.
Full dependencies: horse_drawn_01.OZJ, horse_drawn_02.OZT, horse_drawn_03.OZJ. Dimensions {'horse_drawn_01.jpg': [1024, 1024], 'horse_drawn_02.tga': [512, 512], 'horse_drawn_03.jpg': [512, 512]}.
