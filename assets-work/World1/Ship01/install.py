"""Install eight validated owned files only into this isolated source worktree."""
import hashlib
import json
...
TEXTURES = ('TileGround03.OZJ', 'ship01.OZJ', 'ship03.OZJ', 'ship04.OZJ', 'ship07.OZJ', 'ship05.OZJ', 'ship05.OZT')
...
def main():
    assert subprocess.check_output(['git', 'branch', '--show-current'], cwd=ROOT, text=True).strip() == 'codex/lorencia-ship'
    ...
    record = dict(result='PASS', baseline='1fbe3db6', runtime_modified=False, client_verified=False,
