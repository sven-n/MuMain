"""Import the five immutable originals with official tools into packed Blender projects."""
...
def main():
    for name in ASSETS:
        ...
        command = [BLENDER, '-b', '--python-exit-code', '1', '--python', str(REPOSITORY / 'tools/blender/mu_bmd_import.py'), '--',
