...
Status: offline validated; client verification pending. Compatibility consumer: installed BMD remains byte-identical. Official new roundtrip is retained only in exports/.
Original model provenance: ac16ffeb (accepted Trees01); archive also checked against starting integration HEAD 2d827ed5225979087e9b68fbcf306879b48acd29.
World1 type 10; 165 placements recorded in placements.json.
Full texture dependencies: {'tree_06.tga': ['src/bin/Data/Object1/tree_06.OZT'], 'tree_03.jpg': ['src/bin/Data/Object1/tree_03.OZJ']}.
Material/mesh order: ['tree_06.tga', 'tree_03.jpg'].

Geometry retained deliberately: 169 triangles, 10 bones,
2 material meshes. Original dead-branch/root silhouettes remain recognizable.
...
original dimensions: {'tree_06.tga': [512, 512], 'tree_03.jpg': [512, 256]}. There are no new rendering features or filenames.
...
Exact names, bone order, parents, mesh order, action order, key count (31), lock=0,
