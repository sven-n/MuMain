"""Install exactly the six owned BMDs and four owned textures in this isolated source worktree."""
import hashlib
import json
...
OWNERS = {'HouseEtc01': ('HouseEtc01.bmd', 'c_wall04.OZJ', 'c_wall06.OZJ'),
          'StoneMuWall01': ('StoneMuWall01.bmd', 'c_wall05.OZJ'),
          'StoneMuWall02': ('StoneMuWall02.bmd',),
          'StoneMuWall03': ('StoneMuWall03.bmd',),
          'StoneMuWall04': ('StoneMuWall04.bmd',),
          'HouseEtc02': ('HouseEtc02.bmd', 'tile_ston01.OZJ')}
...
def main():
    ...
    for owner, names in OWNERS.items():
        ...
        for texture in (ROOT / owner / 'exports').glob('*.OZJ'):
