...
PAIRS = {
    'HouseEtc01': [(0, 1), (4, 5)],
    'StoneMuWall01': [(0, 1), (2, 3), (6, 7), (20, 21), (24, 25),
                      (28, 29), (30, 31), (34, 35), (48, 49), (52, 53)],
    'StoneMuWall02': [(36, 37), (38, 39), (40, 41), (42, 43)],
    'StoneMuWall03': [(4, 5), (6, 7), (10, 11), (36, 37)],
    'StoneMuWall04': [(4, 5), (6, 7), (10, 11), (36, 37)],
    'HouseEtc02': [(50, 51), (52, 53), (54, 55)],
}
...
def perimeter(original, pair):
    ...
    edges, points = [], {}
    for face in faces:
        assert original.data.materials[face.material_index].name.endswith('c_wall04.jpg'), original.data.materials[face.material_index].name
...
def validate_source(root, obj, rig, original, bounds, evidence):
    ...
    report = dict(status='PASS: source checks; exported engine checks separately required',
                  ...
                  alpha='All opaque RGB; original material slots retained',
