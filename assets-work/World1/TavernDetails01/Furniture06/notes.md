# Furniture06 — carved high-back chair
...
World1 type 145, 18 placements retained in placements.json.
Complete dependencies, in original BMD mesh order: ('bookshelf.jpg', 'chair2.tga').
Exact containers: ['bookshelf.OZJ', 'chair2.OZT'].
Texture dimensions: {'bookshelf.jpg': [512, 512], 'chair2.tga': [512, 512]}.
Original archive checked byte-for-byte against starting revision 8b85343485ad231b4e1d6e96a6e196d7f0c08bd6.

Replacement: 132 triangles; original info in original/info.txt.
Bone names/order: ['Box11']. Every original parent and local pose is retained.
...
Before bind bounds: [[-20.84, -25.63, -0.04], [21.48, 28.72, 110.86]].
After bind bounds: [[-20.84, -25.63, -0.04], [21.48, 28.72, 110.86]].
...
{'status': 'PASS', 'seat_height': 49.784698486328125, 'original_seat_triangles': 2, 'exact_surface_triangle_max_deviation': 0, 'original_foot_corners': 48, 'max_foot_corner_deviation': 0.0, 'engine_hook': 'CreateOperate preserved; no source or collision edit'}.

Full comparison correctly reports DIFFERENT because geometry was rebuilt:

```
meshes 2 vs 2, bones 1 vs 1, actions 1 vs 1, triangles 54 vs 132
unmatched triangles: 43  max corner distance: 0.0000  max bone distance: 0.0000  differing bone names: 0
DIFFERENT
```
...
Actual exported UV/normal/material audit: {'minimum_uv_triangle_area': 0.10579884999999999, 'minimum_geometry_triangle_area': 5.9999999999999964, 'minimum_winding_normal_dot': 1.0, 'zero_area_triangles': 0, 'winding_disagreements': 0}.
