"""Export remodeled tavern details and prove skeleton, actions, bounds and mesh order."""
...
def validate(name):
    ...
    summary = dict(status='PASS: offline', client_verified=False, geometry='Intentional profile/carpentry rebuild; full geometry comparison DIFFERENT',
