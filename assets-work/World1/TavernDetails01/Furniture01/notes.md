# Furniture01 — pottery and bottle shelf
...
World1 type 140, 2 placements retained in placements.json.
Complete dependencies, in original BMD mesh order: ('pot.jpg', 'pot2.jpg', 'bookshelf.jpg', 'bottle.tga').
Exact containers: ['pot.OZJ', 'pot2.OZJ', 'bookshelf.OZJ', 'bottle.ozt'].
Texture dimensions: {'pot.jpg': [512, 512], 'pot2.jpg': [512, 512], 'bookshelf.jpg': [512, 512], 'bottle.tga': [512, 512]}.
Original archive checked byte-for-byte against starting revision 8b85343485ad231b4e1d6e96a6e196d7f0c08bd6.

Replacement: 732 triangles; original info in original/info.txt.
Bone names/order: ['Cylinder07', 'Cylinder06', 'Box12', 'Cylinder26', 'Cylinder29', 'Cylinder30']. Every original parent and local pose is retained.
...
Before bind bounds: [[-80.22, -23.37, 0.0], [79.96, 23.06, 210.08]].
After bind bounds: [[-80.22, -23.37, 0.0], [79.96, 23.06, 210.08]].
...
```
meshes 4 vs 4, bones 6 vs 6, actions 1 vs 1, triangles 272 vs 732
unmatched triangles: 266  max corner distance: 0.0000  max bone distance: 0.0000  differing bone names: 0
DIFFERENT
```
...
Actual exported UV/normal/material audit: {'minimum_uv_triangle_area': 4.848722999999962e-05, 'minimum_geometry_triangle_area': 0.1060875057466795, 'minimum_winding_normal_dot': 0.39243477662047316, 'zero_area_triangles': 0, 'winding_disagreements': 0}.
