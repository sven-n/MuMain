# Beer03 — two bottles and tankard
...
World1 type 153, 4 placements retained in placements.json.
Complete dependencies, in original BMD mesh order: ('bottle.tga', 'winecup.jpg').
Exact containers: ['bottle.ozt', 'winecup.OZJ'].
Texture dimensions: {'bottle.tga': [512, 512], 'winecup.jpg': [512, 512]}.
Original archive checked byte-for-byte against starting revision 8b85343485ad231b4e1d6e96a6e196d7f0c08bd6.

Replacement: 516 triangles; original info in original/info.txt.
Bone names/order: ['Cylinder36', 'Cylinder37', 'Cylinder38']. Every original parent and local pose is retained.
...
Before bind bounds: [[-24.01, -13.66, -0.36], [23.71, 16.9, 61.47]].
After bind bounds: [[-24.01, -13.66, -0.36], [23.71, 16.9, 61.47]].
...
```
meshes 2 vs 2, bones 3 vs 3, actions 1 vs 1, triangles 108 vs 516
unmatched triangles: 108  max corner distance: 0.0000  max bone distance: 0.0000  differing bone names: 0
DIFFERENT
```
...
Actual exported UV/normal/material audit: {'minimum_uv_triangle_area': 0.0003839999999999997, 'minimum_geometry_triangle_area': 1.2283481747104548, 'minimum_winding_normal_dot': 0.39422637508432945, 'zero_area_triangles': 0, 'winding_disagreements': 0}.
