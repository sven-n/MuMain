...
World1 type 141, 3 placements retained in placements.json.
Complete dependencies, in original BMD mesh order: ('bottle.tga', 'bookshelf.jpg').
Exact containers: ['bottle.ozt', 'bookshelf.OZJ'].
Texture dimensions: {'bottle.tga': [512, 512], 'bookshelf.jpg': [512, 512]}.
Original archive checked byte-for-byte against starting revision 8b85343485ad231b4e1d6e96a6e196d7f0c08bd6.

Replacement: 1288 triangles; original info in original/info.txt.
Bone names/order: ['Cylinder04', 'Box03', 'Cylinder12', 'Cylinder13', 'Cylinder15', 'Cylinder16', 'Cylinder17', 'Cylinder18', 'Cylinder19', 'Cylinder21', 'Cylinder22', 'Cylinder23', 'Cylinder24']. Every original parent and local pose is retained.
...
Before bind bounds: [[-80.46, -23.38, 0.0], [79.72, 23.05, 228.92]].
After bind bounds: [[-80.46, -23.38, 0.0], [79.72, 23.05, 228.92]].
...
```
meshes 2 vs 2, bones 13 vs 13, actions 1 vs 1, triangles 464 vs 1288
unmatched triangles: 458  max corner distance: 0.0000  max bone distance: 0.0000  differing bone names: 0
DIFFERENT
```
...
Actual exported UV/normal/material audit: {'minimum_uv_triangle_area': 4.848722999999962e-05, 'minimum_geometry_triangle_area': 0.10608588917670139, 'minimum_winding_normal_dot': 0.691118, 'zero_area_triangles': 0, 'winding_disagreements': 0}.
