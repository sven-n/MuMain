...
IDENTITIES = {'Sign01': 'HANGING NOTICE BOARD', 'Sign02': 'STANDING NOTICE BOARD', 'Curtain01': 'BLUE LAUREL STANDARD', 'StoneWall04': 'MOUNTED RIDER STANDARD', 'StoneWall06': 'ACCEPTED PIER COMPATIBILITY'}
ORIGINAL_TRIANGLES = {'Sign01': 30, 'Sign02': 30, 'Curtain01': 68, 'StoneWall04': 36, 'StoneWall06': 88}
...
def batch_sheet():
    ...
    draw = ImageDraw.Draw(canvas)
    text(draw, (30, 20), 'LORENCIA  /  NOTICES AND HERALDIC STANDARDS', 32)
    text(draw, (30, 68), 'OFFLINE BLENDER EXPORT REVIEW  /  Four models / 26 placements + two pier compatibility placements  /  Client verification pending', 22, MUTED)
    ...
    text(draw, (30, 1200), 'Preserved symbols, alpha fields and attachment dimensions. All skeleton/action comparisons EQUIVALENT.', 23, MUTED)
