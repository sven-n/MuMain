# Sign02: Standing notice board with two posts
...
World1 placements: 5; complete untouched transforms in `original/placements.json`.
Game path: `src/bin/Data/Object1/Sign02.bmd`.
Triangles: 30 → 46.
Before bind bounds: `[[-48.56, -5.94, -0.67], [50.79, 9.47, 134.44]]`.
After bind bounds: `[[-48.56, -5.94, -0.67], [50.79, 9.47, 134.44]]`.
...
Max retained normal direction change: 0.002355033 degrees.
Official SMD export normalizes/requantizes normals; no byte-equivalence of recomputed normals is claimed.

- `Sign02.smd`: 1 frames / 1 bone samples; max local position drift 0.000000000, max local rotation-matrix component drift 0.000000000.
- `Sign02_a00.smd`: 1 frames / 1 bone samples; max local position drift 0.000000000, max local rotation-matrix component drift 0.000000000.
