...
for name in ('Sign01','Curtain01','StoneWall04','StoneWall06'):
    folder=ROOT/name
    ...
    text(draw,(30,1150),'All keys validated numerically. Alpha >0.25 approximated on both sides. Client playback still pending.',21,MUTED)
