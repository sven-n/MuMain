...
ASSETS = ('Sign01', 'Sign02', 'Curtain01', 'StoneWall04', 'StoneWall06')
...
shared.EXPECTED_KEYS = {'Sign01': 21, 'Sign02': 1, 'Curtain01': 26, 'StoneWall04': 25, 'StoneWall06': 25}
...
def protected_parts(folder, original, final, name):
    protected = {'Sign01': ['signboard.tga', 'doorknob.tga'], 'Sign02': [], 'Curtain01': ['badge_01.jpg', 'badge_02.tga'], 'StoneWall04': ['badge_01.jpg', 'badge_03.tga'], 'StoneWall06': ['badge_01.jpg', 'badge_03.tga', 'tile_01.jpg']}[name]
    messages = []
...
def export_validate(name):
    ...
    expected = 'DIFFERENT' if name in ('Sign01', 'Sign02') else 'EQUIVALENT'
