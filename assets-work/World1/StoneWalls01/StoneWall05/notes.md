...
World1 placements: 0; exact transforms are retained in `original/placements.json`.
Game model: `src/bin/Data/Object1/StoneWall05.bmd`.
Triangles: 60 → 100.
Bind bounds before: `[[-199.33, -43.04, -1.61], [198.83, 41.85, 236.54]]`; after: `[[-199.33, -43.04, -1.61], [198.83, 41.85, 236.54]]`.
...
Original rig order: `['Box04', 'Object01']`. Action metadata: `['action 0 keys=1 lock=0']`.
...
- `StoneWall05.smd`: 1 frames, 2 bone samples; max local translation 0.000000000, wrapped rotation 0.000000000 radians.
- `StoneWall05_a00.smd`: 1 frames, 2 bone samples; max local translation 0.000000000, wrapped rotation 0.000000000 radians.
