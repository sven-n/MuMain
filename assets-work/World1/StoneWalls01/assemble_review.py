...
IDENTITIES = {'StoneWall01': 'RAISED PORTCULLIS', 'StoneWall02': 'LOWERED PORTCULLIS', 'StoneWall03': 'ROUGH WALL WITH SIEGE FIXTURE', 'StoneWall05': 'ROUGH WALL MODULE', 'StoneWall06': 'ANIMATED HERALDIC PIER'}
ORIGINAL_TRIANGLES = {'StoneWall01': 318, 'StoneWall02': 318, 'StoneWall03': 293, 'StoneWall05': 60, 'StoneWall06': 56}
...
def batch_sheet():
    ...
    draw = ImageDraw.Draw(canvas)
    text(draw, (30, 20), 'LORENCIA  /  ROUGH STONE DEFENSIVE WALLS', 32)
    text(draw, (30, 68), 'OFFLINE BLENDER EXPORT REVIEW  /  Five models, 18 placements  /  Client verification pending', 22, MUTED)
...
def texture_sheet():
    canvas = Image.new('RGB', (1000, 1060), PAPER)
    draw = ImageDraw.Draw(canvas)
    text(draw, (25, 18), 'MASONRY PAINTINGS  /  ORIGINAL ABOVE, REPAINT BELOW', 31)
    text(draw, (25, 63), 'Original two-course layout retained. Final textures: 512 × 512 RGB.', 23, MUTED)
    sources = [('tile_01', 'StoneWall01'), ('tile_03', 'StoneWall01')]
    ...
    text(draw, (25, 1026), 'Built-in imagegen; prompts and master PNGs retained in paintings/.', 21, MUTED)
...
if __name__ == '__main__':
    ...
    batch_sheet()
    texture_sheet()
    for label in ('raised-gates', 'lowered-gates'):
