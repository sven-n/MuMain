...
Game model: `src/bin/Data/Object1/StoneWall03.bmd`.
Triangles: 293 → 333.
...
- `horse_drawn_01.OZJ` / `horse_drawn_01.jpg`: [256, 256], RGB; frozen byte-identical.
...
Original rig order: `['Box04', 'Box23', 'Box06', 'Object01']`. Action metadata: `['action 0 keys=1 lock=0']`.
...
Maximum retained-normal direction difference: 0.012340020 degrees.
...
- `StoneWall03.smd`: 1 frames, 4 bone samples; max local translation 0.000000000, wrapped rotation 0.000000000 radians.
- `StoneWall03_a00.smd`: 1 frames, 4 bone samples; max local translation 0.000000000, wrapped rotation 0.000000000 radians.
