...
Actual World1 identity: straight roof cap; 4 placements. Exact positions, rotations, scale and tile coordinates are retained in `original/placements.json`.
