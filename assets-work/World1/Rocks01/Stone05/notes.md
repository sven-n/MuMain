...
World1 placements: **8**. Full positions, rotations, scales and tile coordinates: `original/placements.json`.
Game model: `src/bin/Data/Object1/Stone05.bmd`.
Complete ordered texture dependencies: `ston01.jpg`.

Triangles: **120 → 417**. One UV set, one original bone per vertex, finite positions/UVs/normals, no zero-area triangles.
...
- Before: `[[-55.991402, -61.8778, -3.226799], [42.2136, 49.666901, 26.4851]]`
- After: `[[-55.991402, -61.8778, -3.226799], [42.2136, 49.666901, 26.4851]]`
...
Action metadata: `{'Stone05_a00': {'index': 0, 'lock': False}}`.
