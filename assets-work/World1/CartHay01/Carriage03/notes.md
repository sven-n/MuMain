# Carriage03: handcart with two adjacent casks

Owner: ASTRA environment artist `/root/groundcover`, branch `codex/lorencia-cart-hay`.
0 original World1 placements, exact records in `original/placements.json`.
Original revision 8094616d. OFFLINE complete; client verification pending.

Triangles: 346 → 538. Original material/mesh order:
tub.jpg, horse_drawn_01.jpg.
...
Bind bounds before: [[-160.09, -216.33, -1.17], [88.22, 220.78, 182.28]].
Bind bounds after: [[-160.09, -216.33, -1.17], [88.22, 220.78, 182.28]].
...
0.00168205, tolerance .005 units.
