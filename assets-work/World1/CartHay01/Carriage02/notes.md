# Carriage02: empty two-wheel handcart

Owner: ASTRA environment artist `/root/groundcover`, branch `codex/lorencia-cart-hay`.
7 original World1 placements, exact records in `original/placements.json`.
Original revision 8094616d. OFFLINE complete; client verification pending.

Triangles: 258 → 450. Original material/mesh order:
horse_drawn_01.jpg.
...
Bind bounds before: [[-90.38, -218.18, -1.17], [88.7, 218.93, 182.28]].
Bind bounds after: [[-90.38, -218.18, -1.17], [88.7, 218.93, 182.28]].
...
0.00035126, tolerance .005 units.
