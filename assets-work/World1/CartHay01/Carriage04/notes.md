# Carriage04: handcart loaded with three tied straw bundles

Owner: ASTRA environment artist `/root/groundcover`, branch `codex/lorencia-cart-hay`.
2 original World1 placements, exact records in `original/placements.json`.
Original revision 8094616d. OFFLINE complete; client verification pending.

Triangles: 390 → 882. Original material/mesh order:
horse_drawn_01.jpg, grass_01.tga.
...
Bind bounds before: [[-90.86, -216.33, -1.17], [88.22, 220.78, 272.91]].
Bind bounds after: [[-90.86, -216.33, -1.17], [88.22, 220.78, 272.91]].
...
0.00066795, tolerance .005 units.
...
horse_drawn_01.OZJ, grass_01.OZT.
