...
def protected_parts(folder, original, final, name):
    protected = {'FireLight01': ['light.tga', 'light3.jpg'],
                 'FireLight02': ['tile_02.jpg', 'fire_light_01.tga', 'copra_gate.jpg'],
                 'Bonfire01': ['fire_01.jpg', 'fire_02.jpg'],
                 'DoungeonGate01': ['copra_gate.jpg']}[name]
    messages = []
...
def export_validate(name):
    ...
    expected = 'DIFFERENT' if name == 'FireLight01' else 'EQUIVALENT'
