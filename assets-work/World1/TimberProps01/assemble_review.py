...
IDENTITIES = {'House02': 'OPEN WEAPONS BIN', 'TreasureDrum01': 'COOPERED OAK BARREL',
              'StreetLight01': 'ANIMATED TIMBER HANGING LANTERN'}
ORIGINAL_TRIANGLES = {'House02': 173, 'TreasureDrum01': 60, 'StreetLight01': 84}
...
def review_sheet(name):
    ...
    text(draw, (30, 1020), 'NOT CLIENT SCREENSHOTS. Matching Blender camera/light; lantern additive appearance approximated. In-game lighting and placements unverified.', 20, MUTED)
...
def action_sheet(name):
    ...
    draw = ImageDraw.Draw(canvas)
    text(draw, (30, 20), f'{name.upper()}  /  ORIGINAL 21-FRAME ACTION', 30)
...
def batch_sheet():
    ...
    draw = ImageDraw.Draw(canvas)
    text(draw, (30, 22), 'LORENCIA  /  BARREL, WEAPONS BIN AND LANTERN', 35)
    ...
    for index, name in enumerate(IDENTITIES):
        x = 25 + 595 * index
        place(canvas, ROOT / name / 'review/after.png', (x, 152), (565, 489))
