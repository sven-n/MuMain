...
38 instances, object type 83. Full untouched placement records are in
`original/placements.json`. Example tile: [120.803095703125, 85.966142578125]; world position:
[12080.3095703125, 8596.6142578125, 154.9999237060547]; rotation degrees: [0.0, 0.0, 450.0]; scale 1.0.
...
- Triangles: 10 → 112 (prop budget 1500).
- Before bind minimum / maximum: -100.41949, -6.81400, 0.00000 / 99.67900, 19.69980, 22.68870.
- Authored minimum / maximum: -100.41949, -6.81400, 0.00000 / 99.67900, 19.69980, 22.68870.
- Engine-reported before bounds: -100.42000, -6.81000, 0.00000 / 99.68000, 19.70000, 22.69000.
- Engine-reported after bounds: -100.42000, -6.81000, 0.00000 / 99.68000, 19.70000, 22.69000.
- One original root bone, `Box01`, index 0, parent -1. Names, order and parents identical.
...
```text
meshes 1 vs 1, bones 1 vs 1, actions 1 vs 1, triangles 10 vs 112
unmatched triangles: 8  max corner distance: 0.0000  max bone distance: 0.0000  differing bone names: 0
DIFFERENT
```
