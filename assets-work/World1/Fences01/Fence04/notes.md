...
17 instances, object type 84. Full untouched placement records are in
`original/placements.json`. Example tile: [122.0, 111.5]; world position:
[12200.0, 11150.0, 164.99998474121094]; rotation degrees: [0.0, 0.0, 450.0]; scale 1.0.
...
- Triangles: 10 → 56 (prop budget 1500).
- Before bind minimum / maximum: -49.81680, -6.81400, 0.00000 / 50.21620, 19.69980, 22.68870.
- Authored minimum / maximum: -49.81680, -6.81400, 0.00000 / 50.21620, 19.69980, 22.68870.
- Engine-reported before bounds: -49.82000, -6.81000, 0.00000 / 50.22000, 19.70000, 22.69000.
- Engine-reported after bounds: -49.82000, -6.81000, 0.00000 / 50.22000, 19.70000, 22.69000.
- One original root bone, `Object02`, index 0, parent -1. Names, order and parents identical.
...
```text
meshes 1 vs 1, bones 1 vs 1, actions 1 vs 1, triangles 10 vs 56
