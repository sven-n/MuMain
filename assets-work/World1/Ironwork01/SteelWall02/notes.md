...
World1 placements: 21. Exact position/rotation/scale/tile records: `original/placements.json`.
Game model: `src/bin/Data/Object1/SteelWall02.bmd`.
Complete ordered texture dependencies: `steel_barred_b.jpg`, `steel_barred_a.tga`.

Triangles: **72 → 328**. Full original/final BMD compare: **DIFFERENT**.
Skeleton/actions-only BMD compare: **EQUIVALENT**. Names/order/parents, material order and one-key action metadata retained.
Original bone order: `['Box04', 'Box05', 'Box06', 'Box07']`.
Action metadata: `{'SteelWall02_a00': {'index': 0, 'lock': False}}`.

Actual converted BMD bind bounds:

- Before: `[[-199.684097, -3.2306, 0.000389], [200.475494, 3.206801, 220.071594]]`
- After: `[[-199.684174, -3.230454, 0.000389], [200.475586, 3.206696, 220.071686]]`
- Largest component drift: `0.000146` game units.
- All 80 original position/bone anchors retained; maximum final distance `0.000396` units.
