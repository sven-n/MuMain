...
from config import PROPS, REPOSITORY, ROOT, ALPHA, OPAQUE
...
def main():
    ...
    assert branch=='codex/lorencia-ironwork',branch
    claimed={f'{name}.bmd' for name in PROPS}|{f'{name}.OZT' for name in ALPHA}|{OPAQUE+'.OZJ'}
    ...
    exports[OPAQUE+'.OZJ']=ROOT/'textures'/(OPAQUE+'.OZJ')
