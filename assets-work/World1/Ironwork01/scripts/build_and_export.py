"""Refine solid iron bar profiles while preserving modular endpoints and alpha planes."""
import hashlib
import json
...
from refine_profiles import refine
...
def build(name):
    ...
    refinement = [refine(obj) for obj in active]
    ...
    report = {'original_reference_unchanged': True, 'geometry_unchanged': name == 'HouseEtc03',
