...
Game model: `src/bin/Data/Object1/SteelDoor01.bmd`.
Complete ordered texture dependencies: `steel_barred_b.jpg`, `steel_barred_door.tga`.

Triangles: **58 → 218**. Full original/final BMD compare: **DIFFERENT**.
...
Action metadata: `{'SteelDoor01_a00': {'index': 0, 'lock': False}}`.

Actual converted BMD bind bounds:

- Before: `[[-1.550201, -6.617287, 0.453094], [152.895706, 6.704713, 356.476501]]`
- After: `[[-1.550201, -6.617188, 0.453094], [152.895706, 6.704893, 356.476501]]`
- Largest component drift: `0.000180` game units.
- All 56 original position/bone anchors retained; maximum final distance `0.000188` units.
