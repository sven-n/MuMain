# House05 — Animated watermill with raised water flume and turning wheel
...
Identity and World1 placement: Animated watermill with raised water flume and turning wheel. 1 existing placements; exact positions, XYZ rotations, scale and tile coordinates in `original/placements.json`.

Geometry: 276 → 324 triangles. All wheel, flume, scrolling water, supporting timber and original wall perimeters remain unchanged. Only six fixed ashlar wall panels are dressed. Footprint, origin, orientation, bone pivots and all original corners retained. New recess depths are 0.18 units for ladder wear, 0.4 for roof interiors and 0.65 for stone panels. Explicit modified pairs/perimeters are recorded in `validation/blender.json`. This is conservative architectural edge refinement, with the primary visual gain supplied by the shared material paintings.

Material slots, unchanged order: tile_wood02.jpg, tile_wood01.jpg, ston02.jpg.
...
- `ston02.jpg`: [128, 128], RGB
- `tile_wood01.jpg`: [512, 512], RGB
- `tile_wood02.jpg`: [128, 128], RGB

Frozen dependency containers retained byte for byte: tile_wood02.OZJ, ston02.OZJ.
...
Bind bounds before: `[[-200.18, -275.53, -147.38], [293.51, 601.86, 359.64]]`.
Bind bounds after: `[[-200.18, -275.53, -147.38], [293.51, 601.86, 359.64]]`.
Every original vertex position/bone survives final conversion within 0.000016000 units. 264 protected triangles retain positions, bone assignments and UVs. Maximum retained UV delta 0; normal component delta 0.000001000; normal direction delta 0.00001924 degrees. Original UV ranges: `[[-1.7887, 2.3836], [-0.7074, 2.1322]]`.

Rig: `['ki12', 'Box02', 'Box03', 'Box04', 'Box05', 'Box06', 'Box01', 'Box08', 'Box07', 'Mesh01']`. Names, indices, order, parents and original one-action lock metadata unchanged; 30 action keys. Full local pose evidence: `[{'file': 'House05.smd', 'bone_samples': 10, 'frames': 1, 'max_position_component': 0, 'max_euler_component_radians': 0}, {'file': 'House05_a00.smd', 'bone_samples': 300, 'frames': 30, 'max_position_component': 0, 'max_euler_component_radians': 0}]`. All 300 hierarchical action matrices match with maximum component delta 0; every action-frame bound matches with maximum component delta 0. Per-frame matrices/bounds evidence is in `validation/matrices-and-posed-bounds.json`.
