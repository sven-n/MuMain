# Tree02 — large spreading oak-like tree
...
World1 type 1, 23 placements; exact records in `placements.json`.
Game file: `src/bin/Data/Object1/Tree02.bmd`.
...
Geometry retained: 770 triangles, 2 meshes, 24 bones.
...
Bind bounds before: [[-375.5, -399.63, -5.23], [469.63, 340.3, 893.52]].
Bind bounds after: [[-375.5, -399.63, -5.23], [469.63, 340.3, 893.52]].

Full converter comparison:

```
meshes 2 vs 2, bones 24 vs 24, actions 1 vs 1, triangles 770 vs 770
unmatched triangles: 0  max corner distance: 0.0048  max bone distance: 0.0002  differing bone names: 0
EQUIVALENT
```
