...
def build():
    ...
    profile = [(heights[0], radius[0], .0005), (2, 10.95, .040), (7, 12.9, .144),
               (13, 15.2, .269), (heights[1], radius[1], .4023), (24, 18.08, .497),
               (27.5, 18.46, .570), (heights[2], radius[2], .6261),
               (33, 17.70, .685), (36, 14.60, .747), (39, 10.65, .810),
               (heights[3], radius[3], .8636), (44.5, 8.85, .915),
    ...
    for ring_index, (z, r, v) in enumerate(profile):
        ...
        for segment in range(SEGMENTS + 1):
            ...
            elif round(z, 4) in rings and segment % 3 == 0:
