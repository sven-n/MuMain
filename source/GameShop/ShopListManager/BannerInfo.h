...
public:	
	...
	char	BannerName[BANNER_LENGTH_NAME];				//  2. 배너 그룹 명
	char	BannerImageURL[INTERNET_MAX_URL_LENGTH];	//  3. 배너 이미지 URL
	...
	char	BannerLinkURL[INTERNET_MAX_URL_LENGTH];		//  8. 배너 링크 URL

	char	BannerImagePath[MAX_PATH];					// 배너 이미지 파일 로컬 경로
};
