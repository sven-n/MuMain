...
// 5. [패치이후 디파인]은 패치담당자 이외에는 건들지 마시오.
//
//  << 2. define 규정 >>
// // - 작업자 이름
...
//#define KJH_MOD_INGAMESHOP_SELECT_CASHPOINT_SYSYEM_ONLY_GLOBAL		// 인게임샵 캐시 포인트 선택 시스템 기능 ON (10.05.19)
//#define KJH_MOD_RADIOBTN_MOUSE_OVER_IMAGE							// 라디오버튼 마우스 오버 시 이미지 기능 변경 (10.05.19)
...
// << 버그수정 패치 >>
//----------------------------------------------------------------------------------------------
// [2009.10.01 글로벌 1.03f] - 박보근

#define PBG_FIX_SEALTOOLTIP_BUG_ENG					// 상승의인장 툴팁변경 (09.09.30) - 글로벌 전용
...
#define LDK_FIX_TICKET_INFO							// 악마의광장입장권, 블러드캐슬입장권 레벨 자동적용 문구 추가. (09.06.23)
#define LDK_FIX_PC4_SEALITEM_TOOLTIP_BUG_ENG		// 치유의인장 툴팁 변경 (09.06.23) - 글로벌전용
