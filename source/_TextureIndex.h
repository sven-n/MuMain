...
enum
{
	...
	BITMAP_NEWUI_SHOP_LEFTBT,
	BITMAP_NEWUI_SHOP_LEFTBT_END	    = BITMAP_NEWUI_SHOP_LEFTBT+9,

	BITMAP_NEWUI_SHOP_LEFTDISPLAYBT,
	BITMAP_NEWUI_SHOP_LEFTDISPLAYBT_END	= BITMAP_NEWUI_SHOP_LEFTDISPLAYBT+17,

	BITMAP_NEWUI_SHOP_RIGHTBT,
	BITMAP_NEWUI_SHOP_RIGHTBT_END		= BITMAP_NEWUI_SHOP_RIGHTBT+5,

	BITMAP_NEWUI_SHOP_FRAMESHOPBT,
	BITMAP_NEWUI_SHOP_FRAMESHOPBT_END	= BITMAP_NEWUI_SHOP_FRAMESHOPBT+1,

	BITMAP_NEWUI_SHOP_MAINBACKPANEL,
	BITMAP_NEWUI_SHOP_MAINBACKPANEL_END = BITMAP_NEWUI_SHOP_MAINBACKPANEL+14,

	BITMAP_NEWUI_SHOP_SUBBACKPANEL,
	BITMAP_NEWUI_SHOP_SUBBACKPANEL_END  = BITMAP_NEWUI_SHOP_SUBBACKPANEL+8,
