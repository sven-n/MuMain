# CMake toolchain file for x64 Windows builds with MSVC and Ninja
# This file configures the compiler and SDK paths for 64-bit builds
...
if (MSVC_VERSIONS)
  ...
  # Set x64 compilers
  set(CMAKE_C_COMPILER "${MSVC_PATH}/bin/Hostx64/x64/cl.exe")
  set(CMAKE_CXX_COMPILER "${MSVC_PATH}/bin/Hostx64/x64/cl.exe")
  ...
  if (WIN_SDK_VERSIONS)
    ...
    # Set linker flags to specify x64 library paths explicitly
    # This is necessary because we clear the LIB environment variable
    set(CMAKE_EXE_LINKER_FLAGS_INIT "/LIBPATH:\"${WIN_SDK_LIB_PATH}/um/x64\" /LIBPATH:\"${WIN_SDK_LIB_PATH}/ucrt/x64\" /LIBPATH:\"${MSVC_PATH}/lib/x64\"")
    set(CMAKE_SHARED_LINKER_FLAGS_INIT "/LIBPATH:\"${WIN_SDK_LIB_PATH}/um/x64\" /LIBPATH:\"${WIN_SDK_LIB_PATH}/ucrt/x64\" /LIBPATH:\"${MSVC_PATH}/lib/x64\"")
    set(CMAKE_MODULE_LINKER_FLAGS_INIT "/LIBPATH:\"${WIN_SDK_LIB_PATH}/um/x64\" /LIBPATH:\"${WIN_SDK_LIB_PATH}/ucrt/x64\" /LIBPATH:\"${MSVC_PATH}/lib/x64\"")
    ...
    message(STATUS "x64 Toolchain: Using MSVC ${MSVC_PATH}")
    message(STATUS "x64 Toolchain: Using Windows SDK ${WIN_SDK_VERSION}")
